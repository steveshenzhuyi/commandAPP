  ...
  <div>
    <mt-tab-container class="page-tabbar-container" v-model="selected">
      ...
      <mt-tab-container-item id="统计">
        ...
        <br><br>
        <div id ="myChart1" style="width:344px;height:300px"></div><hr>
        <div id ="myChart2" style="width:344px;height:300px"></div><hr>
        <div id ="myChart3" style="width:344px;height:300px"></div><hr>
        <div id="myChart4" style="width:344px;height:300px"></div><hr>
        <div id ="myChart5" style="width:344px;height:300px"></div>
                <br><br>
      </mt-tab-container-item>
    </mt-tab-container>
